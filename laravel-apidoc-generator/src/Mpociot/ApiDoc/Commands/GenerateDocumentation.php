...
use Mpociot\ApiDoc\Generators\DoctrineGenerator;
...
class GenerateDocumentation extends Command
{
    ...
    protected $signature = 'api:generate
                            ...
                            {--router=laravel : The router to be used (laravel, dingo, doctrine)}
    ...
    /**
     * @return DoctrineGenerator|DingoGenerator|LaravelGenerator
     */
    private function getGenerator()
    {
        switch ($this->option('router')) {
            ...
            case 'dingo':
                ...
                break;
            case 'doctrine':
                $generator = new DoctrineGenerator();
                break;
        }
        return $generator;
    }
